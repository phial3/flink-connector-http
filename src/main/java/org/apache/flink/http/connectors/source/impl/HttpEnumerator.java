...
public class HttpEnumerator<SplitT extends HttpSourceSplit>
    ...
    private final HttpSourceSplitAssigner<SplitT> splitAssigner;
    private final HttpSourceParameters parameters;

    private final LinkedHashMap<Integer, String> readersAwaitingSplit;

    public HttpEnumerator(SplitEnumeratorContext<SplitT> context, HttpSourceSplitEnumerator<SplitT> splitEnumerator, HttpSourceSplitAssigner<SplitT> splitAssigner, HttpSourceParameters parameters) {
